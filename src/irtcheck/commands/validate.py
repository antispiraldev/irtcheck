...
def run(**kwargs: Any) -> None:
    raise NotImplementedError(
        "`irtcheck validate` is not implemented yet — it belongs to the wave1/select-validate brief "
        "(see docs/build-plan.html). Expected arguments: artifact, sizes, as_json, seed, epochs."
    )
